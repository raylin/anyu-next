...
const MODE_DEFINITIONS = {
  ...
  recovery_link_smoke: {
    ...
    mustMatchPreviewStaging: ["OPERATOR_TEST_SECRET", "PAYMENT_RECOVERY_LINK_TOKEN_SECRET"],
    neverProduction: [
      "ENABLE_OPERATOR_FAKE_PAID_SUCCESS",
      "OPERATOR_TEST_SECRET",
      "ENABLE_NEWEBPAY_CHECKOUT",
    ...
    missingBehavior: "blocks before operator_test recovery-link creation and never prints raw prl_/pa_/pcs_ values",
  },
  manual_fallback: {
