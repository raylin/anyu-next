...
describe("contact capture legacy notification UI", () => {
  it("renders LINE as an optional notification CTA and Email as secondary fallback", () => {
  ...
  it("shows the missing-url fallback note when no LINE url is configured", () => {
    ...
    expect(html).toContain("LINE 通知連結暫時還沒準備好，請先改用 Email 接收通知。");
  });
});
